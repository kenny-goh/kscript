...
public class GenerateAst {
    ...
    private static void defineAst(String outputDir, String baseName, List<String> types) throws IOException {
        ...
        writer.println("/**");
        writer.println("* Generated by GenerateAst tool");
        writer.println("* ");
        writer.println("* Grammar");
        writer.println("* expression    -> literal | unary | binary | grouping;");
        writer.println("* literal       -> NUMBER | STRING | \"true\" | \"false\" | \"nil\";");
        writer.println("* grouping      -> \"(\" expression \")\"");
        writer.println("* unary         -> ( \"-\" | \"!\" )");
        writer.println("* binary        -> expression operator expression");
